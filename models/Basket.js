...
const pretty = (basket) => {
    ...
    class Basket {
        ...
        async append(basketId, productId, quantity, quantity_trunk, materialId, cellshapeId, edgingId, bodyId, trunkId, thirdrowId, saddleId, steelId, organizerId, organizerfiftyId, quantity_organizer, quantity_organizerfifty) {
            await BasketProductMapping.create({ basketId, materialId, cellshapeId, edgingId, bodyId, trunkId, thirdrowId, productId, quantity, quantity_trunk, saddleId, steelId, organizerId, organizerfiftyId, quantity_organizer, quantity_organizerfifty })
